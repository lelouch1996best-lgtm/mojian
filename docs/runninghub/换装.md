...
```javascript
const RUNNINGHUB_API_KEY = ""; // Your API Key created in Access Keys
...
const runModel = async () => {
  ...
  const url = "https://www.runninghub.ai/openapi/v2/run/ai-app/2012848202482978818";
  const headers = {
  ...
  "nodeInfoList": [
    {
      "nodeId": "107",
      "fieldName": "image",
      "fieldValue": "pasted/b3d4155904898bf44d38faa464bca2d2bf5ce85301f29f4109143a7ffb77eab8.png",
      "description": "Model image"
    },
    {
      "nodeId": "285",
      "fieldName": "image",
      "fieldValue": "pasted/966328a757f6c17207ffbe7b2975e094fb064f3df982b1290f0cc00674b8a931.png",
      "description": "Replace clothing image"
    },
    {
      "nodeId": "223",
      "fieldName": "value",
      "fieldValue": "让图一的人物穿上图二的衣服",
      "description": "Prompt"
    }
  ],
  ...
  try {
    ...
    if (response.ok) {
      ...
      const queryUrl = "https://www.runninghub.ai/openapi/v2/query";
      while (true) {  
        ...
        if (queryResponse.ok) {
          ...
          if (status === "SUCCESS") {
            if (queryResult.results && queryResult.results.length > 0) {
              const outputUrl = queryResult.results[0].url;
              console.log("Task completed. URL:", outputUrl);
            } else {
              console.log("Task completed but no results found.");
            }
            break;
            ...
            const errorMessage = queryResult.errorMessage || "Unknown error";
            console.error("Task failed:", errorMessage);
            break;
          }
        } else {
          console.error("Error:", queryResponse.status, JSON.stringify(queryResult));
          break;
        }
