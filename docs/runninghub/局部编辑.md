...
const runModel = async () => {
  ...
  const url = "https://www.runninghub.ai/openapi/v2/run/ai-app/2004164487110369282";
  const headers = {
  ...
  "nodeInfoList": [
    {
      "nodeId": "107",
      "fieldName": "image",
      "fieldValue": "clipspace/ef52df21f4cf836fd49696ed1777086d_5043d4e5c779fb469ed836f11608f3d67a9d06c5cbf5d38059b4b68e86cb18b9.png [input]",
      "description": "image (please draw mask)"
    },
    {
      "nodeId": "223",
      "fieldName": "value",
